...
environment	production	2026-09-11 14:39:29.512688	2026-09-11 14:39:29.512688
\.
...
COPY public.que_jobs (priority, run_at, id, job_class, error_count, last_error_message, queue, last_error_backtrace, finished_at, expired_at, args, data, job_schema_version, kwargs) FROM stdin;
\.
...
COPY public.que_lockers (pid, worker_count, worker_priorities, ruby_pid, ruby_hostname, queues, listening, job_schema_version) FROM stdin;
232	10	{NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL}	1	zync-que-64478f74fb-8dn7m	{default}	t	2
\.
...
--
-- Name: index_models_on_record; Type: INDEX; Schema: public; Owner: zync
--

CREATE UNIQUE INDEX index_models_on_record ON public.models USING btree (record_id, record_type);
...
--
-- Name: que_jobs_kwargs_gin_idx; Type: INDEX; Schema: public; Owner: zync
--
